...
The right figure shows the ECG/SCG patch, capable of recording both SCG and ECG signals. And the left figure shows the SCG patch which only records SCG. All patches are programmed in a way that they connected to each other for the multi-node applications.
